...
export const WHO_NEEDS_ORM = [
  ...
  {
    id: "businesses",
    label: "Businesses and Companies",
    title: "Businesses and Companies",
    body: "Your search results are your first sales page for most customers. ORM builds the authoritative brand presence that drives conversions and trust",
...
export const SERVICE_INCLUDES = [
  ...
  },
  {
    ...
    body: "Our editorial team creates high-authority, SEO-optimized content built to rank: thought leadership articles, professional profiles, press features, industry commentary, and branded content. Every piece is crafted to build a credible, dominant presence around your name or brand.",
  },
  {
    id: "seo",
    title: "Search Engine Optimization",
    body: "Every content asset we produce is structured to perform in search. We optimize on-page elements, publication platforms, link architecture, and metadata to give your positive content the ranking power it needs to hold.",
  },
  {
    id: "properties",
  ...
  {
    id: "monitoring",
    title: "Reputation Monitoring and Early Warning",
    body: "Our team monitors your digital presence continuously. New threats, negative mentions, and emerging coverage are identified and flagged before they have time to gain traction.",
  },
  {
    id: "reinforcement",
