  ...
  <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div class="flex w-full flex-col items-center gap-4">
      <div class="mx-auto max-w-2xl text-center">
        ...
        <h2 id="from-our-blog-prerender-heading" class="font-heading text-[28px] font-bold leading-[1.1] text-[#0f2e58] md:text-[36px]">Reputation Management Insights & Guides</h2>
