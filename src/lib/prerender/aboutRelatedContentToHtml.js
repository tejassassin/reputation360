...
function furtherReadingSectionHtml() {
  ...
  <div class="flex flex-col gap-5 md:flex-row md:items-end md:justify-between md:gap-8">
    <div class="max-w-2xl">
      ...
      <h2 id="about-further-reading-heading" class="mt-2 font-heading text-[28px] font-bold leading-[1.1] text-[#0f2e58] md:text-[34px] sm:whitespace-nowrap">Reputation Management Guides & Insights</h2>
