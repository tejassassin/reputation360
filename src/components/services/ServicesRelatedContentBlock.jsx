...
/**
 * Case studies + blog links on /services (mirrors #r360-prerender after hydration).
 */
export function ServicesRelatedContentBlock() {
  return (
    <div
      className="services-related-content relative z-10 -mx-5 overflow-hidden border-t border-[#dce3ec] bg-gradient-to-b from-[#f4f8fc] via-[#f8fafc] to-[#eef2f6] md:-mx-8"
    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl px-5 py-14 md:px-8 md:py-16 lg:py-20">
        <section
