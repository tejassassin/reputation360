...
const VARIANTS = {
  ...
  onDark: {
    ...
    consult: cn(
      "ha-pill inline-flex items-center justify-center gap-2 rounded-xl px-8 py-3.5 font-heading text-sm font-bold transition hover:brightness-95 sm:w-auto md:px-10 md:text-base",
  ...
  compact: {
    ...
    consult:
      "ha-pill m-auto inline-block cursor-pointer rounded-lg bg-cta-consult px-6 py-3 font-heading font-semibold whitespace-nowrap text-white transition-colors hover:brightness-95",
  },
};
