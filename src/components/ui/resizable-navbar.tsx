...
export const NavbarLogo = ({
  ...
  return (
    <a
      href="/"
      className="relative z-20 mr-4 flex items-center gap-2 px-2 py-1 text-white font-heading font-bold text-xl"
    >
      {logoSrc ? (
        <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center shrink-0 pl-0.5">
          <img
            src={logoSrc}
            alt={brandName}
            width={36}
