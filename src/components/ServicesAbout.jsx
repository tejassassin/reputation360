      ...
      <div className="mx-auto max-w-6xl space-y-20 px-5 pb-20 pt-12 md:space-y-24 md:px-8 md:pb-24 md:pt-16 lg:space-y-28 lg:pb-28">
        ...
        <div>
          <div className="flex items-start justify-between gap-6 flex-wrap">
            <div>
              <h2 className="font-heading text-3xl text-navy font-bold">
                What We Do
              </h2>
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            {whatWeDoCards.map((card) => (
              ...
              >
                ...
                <h3 className="mt-4 font-heading text-lg text-navy font-semibold">
                  {card.title}
                </h3>
          ...
          <div className="mt-8 rounded-3xl border border-navy/[0.07] bg-[#eef2f7]/50 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.85)] sm:p-5 md:p-7">
            <div className="grid gap-5 sm:grid-cols-2 md:gap-6">
              {ourResultsCards.map((item) => (
                ...
                >
                  <p className="font-heading text-4xl font-extrabold leading-[1.05] tracking-tight text-navy md:text-[2.625rem]">
                    {item.stat}
                  </p>
        ...
        <div>
          ...
          <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-4">
            <article className="ha-lift md:col-span-2 rounded-[26px] border border-navy/10 bg-[#dfe5f6] p-6 hover:border-[#d9f1d2] hover:bg-[#f6fdf3]">
              ...
              <h3 className="mt-4 font-heading text-[22px] md:text-[18px] leading-[1.2] font-semibold text-[#0f2343]">
            ...
            <article className="ha-lift rounded-[26px] border border-navy/10 bg-white p-6 hover:border-[#d9f1d2] hover:bg-[#f6fdf3]">
              ...
              <h3 className="mt-6 font-heading text-[22px] md:text-[18px] leading-[1.2] font-semibold text-[#142844] md:mt-8">
                LinkedIn Branding
              </h3>
              <p className="mt-5 text-[14px] leading-relaxed text-[#1a2c48]/85 md:text-[15px] md:leading-relaxed">
            ...
            <article className="ha-lift md:col-span-2 rounded-[26px] border border-navy/10 bg-white p-6 hover:border-[#d9f1d2] hover:bg-[#f6fdf3]">
              ...
              <div className="mt-6 flex items-start justify-between gap-6">
                <div className="min-w-0">
                  <h3 className="font-heading text-[22px] md:text-[18px] leading-[1.2] font-semibold text-[#111f37]">
        ...
        <div className="rounded-2xl border border-white/15 bg-[#072f5f] px-6 py-10 text-center text-white shadow-[0_16px_40px_-20px_rgba(7,47,95,0.45)] md:px-10 md:py-12">
          <h2 className="text-center font-heading text-3xl md:text-4xl font-bold">
