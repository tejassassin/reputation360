    ...
    <section className="w-full py-12 px-4">
      ...
      <div className="max-w-7xl mx-auto flex flex-nowrap justify-center gap-5 overflow-x-auto pb-2 ">
        {items.map(({ text, icon: Icon }, i) => (
          <div
            key={i}
            className="cursor-pointer group w-55 shrink-0 rounded-xl border border-navy/10 bg-white px-5 py-5 text-center shadow-md transition-all duration-300 hover:border-green/30 hover:shadow-lg hover:-translate-y-0.5"
          >
