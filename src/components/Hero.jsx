...
function Hero() {
  ...
  return (
    <section className="h-[calc(100dvh-76px)] flex flex-col justify-center bg-linear-to-br from-navy via-slate to-navy text-white py-12 sm:py-8 lg:py-6 overflow-hidden">
