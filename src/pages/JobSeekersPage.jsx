...
function JobSeekersFaqSection() {
  return (
    ...
    >
      <h2 className="max-w-4xl font-heading text-[26px] font-bold leading-[1.12] text-[#0f2e58] md:text-[32px] md:leading-[1.1]">Frequently Asked Questions About Job Seeker Reputation Management</h2>
...
function JobSeekersPage({ renderSeo = true }) {
  const seo = useLocalizedSeo("jobSeekers");
  return (
    <>
      {renderSeo ? (
      <SeoHead
    ...
    <main className="flex-1 bg-offwhite">
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-10 md:py-14 space-y-10">
        ...
        <section className="ha-lift mt-12 md:mt-16 grid md:grid-cols-[1fr_1fr] overflow-hidden rounded-[24px] border border-[#123f70] shadow-[0_16px_34px_rgba(16,35,64,0.22)]">
