          ...
          {BUSINESS_PROBLEM_TILES.map((tile, i) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-[10px] font-semibold leading-snug text-[#0f2e58] md:text-[11px]">{tile.label}</h3>
              </button>
            );
          })}
        </div>
    ...
    >
      ...
      <div className="relative flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <h2 className="font-heading text-[26px] font-bold leading-tight tracking-tight md:text-[32px]">
          The Impact of Negative Search Results on Businesses
        </h2>
      </div>
...
function BusinessesFaqSection() {
  return (
    ...
    >
      <h2 className="max-w-4xl font-heading text-[26px] font-bold leading-[1.12] text-[#0f2e58] md:text-[32px] md:leading-[1.1]">Frequently Asked Questions About Business Reputation Management</h2>
...
function BusinessesPage({ renderSeo = true }) {
  const seo = useLocalizedSeo("businesses");
  return (
    <>
      {renderSeo ? (
      <SeoHead
      ...
      <div className="mx-auto max-w-6xl space-y-10 px-4 py-10 md:px-6 md:py-14">
        <section className="relative overflow-hidden rounded-[8px] bg-[linear-gradient(110deg,#ececf8_0%,#eef3f6_70%,#edf7f3_100%)] px-3 py-6 md:grid md:grid-cols-[1.03fr_0.97fr] md:items-start md:px-4 md:py-7">
          <div className="max-w-[570px]">
            <h1 className="max-w-[560px] font-heading text-[30px] font-bold leading-[1.05] tracking-tight text-[#0f2e58] sm:text-[34px] md:text-[40px]">Business Reputation Management Services - Control What Customers Find</h1>
            ...
            <ConsultationCtas
              variant="inlineLight"
              consultHref="/contact"
              consultLabel="Book a Free Business Consultation"
          ...
          <div className="relative flex h-full min-h-[360px] flex-col overflow-hidden bg-[#041a30] md:min-h-[520px]">
            ...
            <div className="relative z-10 flex h-full min-h-0 w-full flex-1 flex-col justify-end p-8 font-heading text-white antialiased md:p-10">
              ...
              <h2 className="fa-invisible-leak-headline mt-5 w-full max-w-none font-heading text-[22px] font-bold leading-[1.06] tracking-tight sm:text-[26px] md:text-[30px]">
                How Negative Search Results Affect Businesses
              </h2>
            </div>
          </div>
